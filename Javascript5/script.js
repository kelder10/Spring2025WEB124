...
document.getElementById('saturation').addEventListener('input', updateCanvas); // Listen for saturation changes

// Download functionality
document.getElementById('download').addEventListener('click', function () {
    const link = document.createElement('a');
    link.download = 'edited-image.png';
    link.href = canvas.toDataURL(); // Create downloadable image from canvas
